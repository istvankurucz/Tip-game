...
function Home() {
	return (
		<div className="home">
			<section id="homeIntro" className="home__section home__section--intro">
				<Container centered>
					...
					<p className="home__p">
						Try out the most <span className="home__highlight">enjoyable</span> tip game you
						have ever seen!
					</p>
					<p className="home__p">
						Play with your friends, colleagues, family and everyone for the glory to become
						the best tip player of the event!
					</p>
					<p className="home__p">
			...
			<section id="homeWorkflow" className="home__section home__section--workflow">
				<Container centered>
					...
					<p className="home__p">
						...
						<span className="home__highlight">easy to understand system</span> to take care
						about everything in seconds!
					</p>
			...
			<section id="homeUsage" className="home__section home__section--usage">
				<Container centered>
					<h2 className="home__subtitle">
					...
					<ol className="home__list home__list--usage">
						...
						<li data-list-number="5." className="home__list__item">
							Go to <Link className="home__link">Rankings</Link> page and track your position
							on the table.
						</li>
						<li data-list-number="+1" className="home__list__item">
